...
LOCAL_STEM := a2109a/device-partial.mk
...
LOCAL_STEM := a2109a/BoardConfigPartial.mk
...
LOCAL_SRC_FILES := libEGL_perfhud.so
LOCAL_MODULE_SUFFIX := .so
LOCAL_MODULE_CLASS := SHARED_LIBRARIES
LOCAL_MODULE_PATH := \$(TARGET_OUT)/lib/egl
LOCAL_MODULE_TAGS := optional
...
LOCAL_SRC_FILES := libGLESv1_CM_perfhud.so
LOCAL_MODULE_SUFFIX := .so
LOCAL_MODULE_CLASS := SHARED_LIBRARIES
LOCAL_MODULE_PATH := \$(TARGET_OUT)/lib/egl
LOCAL_MODULE_TAGS := optional
...
LOCAL_SRC_FILES := libGLESv2_perfhud.so
LOCAL_MODULE_SUFFIX := .so
LOCAL_MODULE_CLASS := SHARED_LIBRARIES
LOCAL_MODULE_PATH := \$(TARGET_OUT)/lib/egl
LOCAL_MODULE_TAGS := optional
